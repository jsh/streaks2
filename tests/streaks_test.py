...
def test_missing_streak_lengths() -> None:
...
def test_kvstreaks_generate_kv_streaks_for_all_permutations() -> None:
...
def test_str_stats_initialization() -> None:
    n = 3
    stats = StreakStatistics(n)
    assert stats.n == n
...
def test_str_stats_by_length() -> None:
    n = 3
    stats = StreakStatistics(n)
    assert len(stats.by_length()) == n


def test_str_stats_by_count() -> None:
    n = 3
    stats = StreakStatistics(n)
    assert len(stats.by_count()) == n


def test_str_stats_of_length() -> None:
    n = 3
    stats = StreakStatistics(n)
...
def test_str_stats_of_count() -> None:
    n = 3
    stats = StreakStatistics(n)
